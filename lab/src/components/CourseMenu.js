    ...
    <>
      {!nav2 && (
        <>
          <button
            onClick={handleNav2}
            className="bg-[#ff0000] w-[3%] h-12 rounded-r-full fixed"
          >
            <img
              className="pl-[10px]"
              src="https://img.icons8.com/external-solid-adri-ansyah/20/ffffff/external-music-music-player-button-solid-adri-ansyah-28.png"
              alt="Music icon"
            />
          </button>
        </>
      ...
      {nav2 && (
        <div className="bg-[#E8E8E8] bg-opacity-40 w-[23%] ease-in-out duration-500 fixed">
          <div>
            <button className="font-extrabold">
              <IoClose color="red" size={25} onClick={handleNav2} />
            </button>
          </div>

          <ul className="flex items-start justify-start ml-[3%] flex-col flex-wrap w-[100%]">
            <li
              className={`flex flex-row ${
                t1
                  ? "bg-[#FF0000] text-white font-bold w-[85%] text-[22px] h-[5%] rounded-[15px]"
                  : "text-[#ff0000] text-[20px] font-bold"
              }`}
            >
            ...
            {t1 && (
              <ul className="ml-4 mt-2 flex flex-col items-start text-[14px] text-[#ff0000]">
                <li className="flex items-center ">
                  <img
                    src="https://img.icons8.com/ios-filled/12/ff0000/filled-circle.png"
                    alt="Red Circle"
                  />
                ...
                <li className="flex items-center">
                  <img
                    src="https://img.icons8.com/sf-regular-filled/12/ff0000/circled.png"
                    alt="circled"
                  />
                ...
                <li className="flex items-center">
                  ...
                  />
                  <span className="ml-2">
                    Арифметичні та логічні операції з числами
                  </span>
                </li>
                <li className="flex items-center">
                  <img
                  ...
                  />
                  <span className="ml-2">
                    Умовні конструкції, конструкція if
                  </span>
                </li>
                <li className="flex items-center">
                  <img
            ...
            <li
              className={`flex flex-row ${
                t2
                  ? "bg-[#FF0000] text-white font-bold w-[85%] text-[22px] h-[5%] mt-[10%] rounded-[15px]"
                  : "text-[#ff0000] mt-[2%] text-[20px] font-bold"
              }`}
            >
              <div className="pl-2 flex items-center">
            ...
            {t2 && (
              <ul className="ml-4 mt-2 flex flex-col items-start text-[14px] text-[#ff0000]">
                ...
                <li className="flex items-center">
                  ...
                  />
                  <span className="ml-2">
                    Атрибути класу та статичні методи
                  </span>
                </li>
                <li className="flex items-center">
                  <img
                  ...
                  />
                  <span className="ml-2">
                    Клас оbject. Представлення об'єкту
                  </span>
                </li>
              </ul>
            )}
            ...
            <li
              className={`flex flex-row ${
                t6
                  ? "bg-[#FF0000] text-white font-bold w-[85%] text-[22px] h-[5%]  mt-[10%] rounded-[15px] "
                  : "text-[#ff0000] mt-[2%] text-[20px] font-bold mb-[10%]"
              }`}
            >
              <div className="pl-2 flex items-center">
